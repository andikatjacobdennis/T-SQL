...
> _[Screenshot: SSMS login dialog with localhost and Windows Auth selected]_
...
> _[Screenshot: New Database dialog with file configuration]_
...
> _[Screenshot: Relationship dialog with tables linked]_
...
> _[Screenshot: Stored Procedure script window]_
...
> _[Screenshot: Object Explorer with right-click menu]_
...
> _[Screenshot: Backup dialog with compression enabled]_
...
> _[Screenshot: Generate Scripts wizard with options]_
...
> _[Screenshot: Profiler trace with duration column]_
...
> _[Screenshot: Query identifying unused tables]_
