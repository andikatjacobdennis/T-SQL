...
**Answer:**
```sql
-- T-SQL (Transact-SQL) is Microsoft's extension to SQL (Structured Query Language)
-- that adds programming constructs, local variables, and other features
SELECT 'T-SQL is Microsoft''s proprietary extension to SQL' AS Answer;
```
