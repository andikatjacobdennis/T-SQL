...
- The evolution of SQL began in the 1970s when E.F. Codd introduced the relational model and IBM's System R (IBM System R is a database system) project developed SQL. 
